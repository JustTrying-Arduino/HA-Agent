...
`AGENTS.md` sert de hub de contribution. La documentation fonctionnelle detaillee vit dans `docs/fonctionnel/`.

Regles:
- `AGENTS.md` et `CLAUDE.md` doivent rester alignes. Toute modification de fond de l'un doit etre repercutee dans l'autre, hors differences de nom de fichier si necessaire.
...
- [`docs/fonctionnel/veille-boursiere.md`](./docs/fonctionnel/veille-boursiere.md): veille EOD via Marketstack, cache local et strategies simples de rebond
